...
const ReadyForPickup = ({ orderid }) => {
  ...
  return (
    <div className="flex flex-col gap-4 rounded-lg shadow-[0_0_16px_rgba(0,0,0,0.16)] my-4">
      <div className="bg-orange-500/5 border border-orange-600 p-4 rounded-t-xl flex flex-row w-full justify-between items-center shadow-sm">
      ...
      <div className="flex flex-row w-full h-full">
        ...
        <div className="grid grid-cols-2 w-1/2 gap-x-8 gap-y-4 p-6 flex-grow overflow-auto">
          ...
          <div className="relative w-full max-w-full md:max-w-3xl mx-auto" style={{ minHeight: "9rem" }}>
            {imageUrls.length > 1 && (
              <button
                className="absolute left-2 top-1/2 -translate-y-1/2 z-20 shadow-lg p-2 md:p-3 rounded-full focus:outline-none focus:ring-2 focus:ring-orange-600 bg-white/80 hover:bg-orange-700 hover:text-white transition-colors border border-orange-200"
                style={{
                  height: "2.5rem",
                  width: "2.5rem",
                  display: "flex",
            ...
            {imageUrls.length > 1 && (
              <button
                className="absolute right-2 top-1/2 -translate-y-1/2 z-20 shadow-lg p-2 md:p-3 rounded-full focus:outline-none focus:ring-2 focus:ring-orange-600 bg-white/80 hover:bg-orange-700 hover:text-white transition-colors border border-orange-200"
                style={{
                  height: "2.5rem",
                  width: "2.5rem",
                  display: "flex",
          ...
          {modal.open && (
            ...
            >
              ...
              {modal.index > 0 && (
                <button
                  className="absolute left-6 top-1/2 -translate-y-1/2 z-10 shadow-lg p-3 rounded-full bg-white/80 hover:bg-orange-700 hover:text-white border border-orange-200"
                  onClick={() => navigate(-1)}
                  aria-label="Previous"
                  style={{
                    height: "3rem",
              ...
              {modal.index < imageUrls.length - 1 && (
                <button
                  className="absolute right-6 top-1/2 -translate-y-1/2 z-10 shadow-lg p-3 rounded-full bg-white/80 hover:bg-orange-700 hover:text-white border border-orange-200"
                  onClick={() => navigate(1)}
                  aria-label="Next"
                  style={{
                    height: "3rem",
