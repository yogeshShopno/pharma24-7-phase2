...
const ItemWiseMargin = () => {
  ...
  const ItemWiseColumns = [
    ...
    { id: "sales_amount", label: "Sale Amt.", minWidth: 150 },
    { id: "purches_amount", label: "Purchase", minWidth: 150 },
    { id: "net_gst", label: "Net GST", minWidth: 150 },
    { id: "net_profit", label: "Profit(%)", minWidth: 150 },
  ];
  ...
  const exportToCSV = () => {
    if (itemMarginData.length == 0) {
      ...
      const filteredData = itemMarginData?.iteam_margin_report?.map(
        ({
          name,
          company,
          sales_count,
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="sub_itm_mrg_fld">
                          ...
                          <p className="secondary font-semibold bit_itm_summ">
                            Rs. {itemMarginData?.total_purches}
                          </p>
                        </div>
                        <div className="sub_itm_mrg_fld">
                          <span className="primary font-bold">
                          ...
                          <p className="secondary font-semibold bit_itm_summ">
                            Rs. {itemMarginData?.total_net_gst}
                          </p>
                        </div>
                        <div className="sub_itm_mrg_fld">
                          <span className="primary font-bold">
                          ...
                          >
                            Rs.{" "}
                            {parseFloat(
                              itemMarginData?.total_net_profit
                            ).toFixed(2)}
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="overflow-x-auto mt-4">
                      ...
                      >
                        ...
                        <tbody style={{ background: "#3f621217" }}>
                          {itemMarginData.iteam_margin_report?.map(
                            (item, index) => (
                              <tr key={index}>
                                {ItemWiseColumns.map((column, colIndex) => (
                                  <td
                                    key={column.id}
                                    style={
                                      colIndex === 0
