...
const Top_Customers = () => {
  ...
  const TopCustomerColumns = [
    ...
    { id: "customer_mobile", label: "Customer Mobile", minWidth: 150 },
    { id: "net_amt", label: "Total Amount", minWidth: 150 },
    { id: "order_count", label: "Orders Count", minWidth: 150 },
  ];
                              ...
                              {TopCustomerColumns.map((column, colIndex) => {
                                ...
                                return (
                                  <td
                                    ...
                                    align={column.align}
                                    style={
                                      colIndex === TopCustomerColumns.length - 1
